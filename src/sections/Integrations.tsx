        ...
        <div className="container">
            <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                <div>
                    ...
                    <p className="text-white/50 mt-4 text-lg">Layers seamlessly connects with your favourite tool it easy to plug into any workflow and collaborate platform. </p>
                </div>
                <div>
